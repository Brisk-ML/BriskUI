      ...
      <DialogContent className="max-w-[95vw] sm:max-w-[90vw] md:max-w-[600px] border-2 border-[#404040] bg-[#181818] p-4 sm:p-6 md:max-h-[85vh]">
        ...
        <DialogFooter className="flex flex-col-reverse sm:flex-row justify-end gap-3 sm:gap-4 mt-4 sm:mt-6">
          ...
          <Button
            type="button"
            onClick={handleSave}
            className="bg-[#006b4c] text-white h-10 sm:h-11 md:h-[40px] px-4 sm:px-6 text-sm sm:text-base md:text-[18px] font-display hover:bg-[#005a3f] transition-colors border-0 w-full sm:w-auto"
          >
            Save Changes
          </Button>
        </DialogFooter>
