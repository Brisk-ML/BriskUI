      ...
      <header className="bg-bg-secondary px-4 sm:px-6 md:px-8 lg:px-12 py-4 sm:py-5 md:py-6 lg:py-[20px]">
        <div className="flex flex-col lg:flex-row lg:items-start gap-6 sm:gap-8 lg:gap-12">
          <div className="flex flex-col gap-4 sm:gap-5 md:gap-6 lg:min-w-[400px]">
            ...
            >
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-[48px] font-bold text-white font-display leading-tight drop-shadow-[0_4px_4px_rgba(0,0,0,0.25)] group-hover:text-accent-400 transition-colors">
                {projectName}
              </h1>
              <Settings className="w-6 h-6 text-text-tertiary group-hover:text-accent-400 transition-colors opacity-0 group-hover:opacity-100" />
            </div>
            ...
            <div className="flex gap-6 sm:gap-8 md:gap-12 lg:gap-[75px] items-center pl-1 sm:pl-2 lg:pl-[13px]">
              <img
                src="/gthub.svg"
                alt="GitHub"
                className="w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 cursor-pointer opacity-80 hover:opacity-100 transition-opacity"
              />
              <img
        ...
        <div className="flex-1 border-2 border-border-primary px-4 sm:px-5 md:px-6 lg:px-[26px] py-4 sm:py-5 md:py-6 lg:py-[29px] flex flex-col bg-bg-dashboard">
          <div className="flex-1 flex flex-col xl:flex-row gap-4 sm:gap-5 md:gap-6 lg:gap-[35px]">
            ...
            <div className="flex-1 xl:flex-[2.5] 2xl:flex-[2.93] border-2 border-border-secondary p-4 sm:p-5 md:p-4 lg:p-[18px] flex flex-col bg-bg-secondary">
              <div className="relative w-fit mb-8 sm:mb-12 lg:mb-16">
                <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-[36px] font-bold text-white mb-2 sm:mb-3 lg:mb-[16px] tracking-tight leading-none font-display">
                  Result Summary
                </h2>
            ...
            <div className="flex-1 border-2 border-border-secondary p-4 sm:p-5 md:p-4 lg:p-[18px] flex flex-col bg-bg-secondary">
              <div className="relative w-fit mb-8 sm:mb-12 lg:mb-16">
                <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-[28px] font-normal text-white mb-2 sm:mb-3 lg:mb-[22px] tracking-tight leading-none font-display">
                  Recent Activity
                </h2>
                <div className="h-[2px] bg-white w-full" />
              </div>
